...
const Navbar = () => {
  ...
  return (
    <header
      className={cn(
        "fixed top-0 left-0 right-0 z-50 py-2 sm:py-3 md:py-4 transition-all duration-500 ease-in-out",
        isScrolled 
    ...
    >
      <div className="container flex items-center justify-between px-4 sm:px-6 lg:px-8">
        <a 
          ...
          aria-label="Dream Cine"
        >
          <img 
            src="/dream-cine-logo.png" 
            alt="Dream Cine Logo" 
        ...
        <nav className="hidden md:flex space-x-8">
          <a 
            href="#" 
            className="nav-link text-white hover:text-orange-400 font-semibold"
            onClick={(e) => {
              e.preventDefault();
              scrollToTop();
            }}
